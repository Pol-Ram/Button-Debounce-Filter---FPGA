...
set_property -dict { PACKAGE_PIN B13  IOSTANDARD LVCMOS33 } [get_ports { out_pulse }]; #IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN F14  IOSTANDARD LVCMOS33 } [get_ports { out_counter  }];
...
set_property -dict { PACKAGE_PIN T8   IOSTANDARD LVCMOS33 } [get_ports { led_pulse }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN V9   IOSTANDARD LVCMOS33 } [get_ports { led_counter }]; #IO_L24P_T3_RS1_15 Sch=led[1]
