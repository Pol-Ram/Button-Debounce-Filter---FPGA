...
set_property -dict { PACKAGE_PIN F15   IOSTANDARD LVCMOS33 } [get_ports { bp_s_r }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
set_property -dict { PACKAGE_PIN B13  IOSTANDARD LVCMOS33 } [get_ports { out_1 }]; #IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN F14  IOSTANDARD LVCMOS33 } [get_ports { out_2  }];
#set_property -dict { PACKAGE_PIN D17  IOSTANDARD LVCMOS33 } [get_ports { bp_s_r_out  }];
...
set_property -dict { PACKAGE_PIN T8   IOSTANDARD LVCMOS33 } [get_ports { bp_s_r_out }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN V9   IOSTANDARD LVCMOS33 } [get_ports { led_2 }]; #IO_L24P_T3_RS1_15 Sch=led[1]
