...
HD_PWD='D:/Main/ESECA/S1/VHDL/Proyectos Finales/Proyecto/project_ANTIBOUNCE/project_Antibounce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bounce_proobe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bounce_proobe.tcl -notrace
