...
HD_PWD='D:/Main/ESECA/S1/VHDL/Proyectos Finales/Proyecto/project_ANTIBOUNCE/project_Antibounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bounce_proobe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bounce_proobe.tcl
